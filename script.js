...
const App = () => {
    ...
    // Fetch and listen for real-time data updates from Firestore
    useEffect(() => {
        ...
        const setupInitialData = async () => {
             // Pre-populated data from the contract
            const initialData = {
                totalCost: 226546.48,
                currentSpend: 0,
                stages: {
    ...
    const handleLogin = async (e) => {
        ...
        if (inputPassword === correctPassword) {
            try {
                // Sign in anonymously to link to a unique user ID in Firestore
    ...
    // Update a project stage's completion status
    ...
    // Add a new payment to the project tracker
    ...
    // Toggle completion status for a provisional sum item
    ...
    // Toggle completion status for a prime cost item
    ...
    // Toggle completion status for an excluded item
    ...
    // Renders a simple timeline visualization
    ...
    // Main Dashboard UI
    // Calculate various totals and costs
        ...
        <div className="min-h-screen bg-gray-100 p-4 font-sans text-gray-800">
            ...
            <main className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <section className="bg-white p-6 rounded-lg shadow-md lg:col-span-1">
                    ...
                    {/* Running total for payments made */}
